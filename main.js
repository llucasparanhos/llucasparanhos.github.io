...
function openCase(id,title){
  ...
  bd.innerHTML=
    ...
    +(c.carousel
      ? '<div class="ch-carousel" id="carousel-'+id+'">'
        +'<div class="ch-carousel-track" id="carousel-track-'+id+'">'+c.carousel.map(function(img,i){
          return'<div class="ch-carousel-slide"><img src="img/'+img+'" alt="Slide '+(i+1)+'" style="width:100%;height:100%;object-fit:contain;display:block;"></div>';
        }).join('')+'</div>'
    ...
    +(id!=='wellhub' ? '<div class="ch-imgs"><div class="ch-img-slot wide"><div class="ch-img-slot-lbl">'+id+'-processo.jpg</div></div></div>' : '')
