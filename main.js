...
const CASES={
  ...
  checkout:{
    ...
    insight:'<p>Os heatmaps do Clarity revelaram o ponto exato de abandono: o <strong>primeiro campo do formulário de cadastro</strong>. A virada foi entender que o usuário não abandonava pelo tamanho do formulário — abandonava porque o cadastro aparecia antes de ele ter decidido comprar. A barreira estava no timing, não no campo.</p><p>Mover o cadastro pra depois da confirmação de pagamento não foi uma decisão de UX — foi uma decisão de <strong>funil de conversão</strong>. Apresentei a análise por etapa pro PM. Sem o dado do Clarity, essa mudança não teria passado — porque contrariava a hipótese original do time.</p>',
