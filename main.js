...
const CASES={
  ...
  checkout:{
    ...
    ttl:'Reduzindo abandono de carrinho em 20%<br><em>no checkout de agendamentos de saúde.</em>',
    ...
    en:{
      ...
      ttl:'Reducing cart abandonment by 20%<br><em>in a healthcare scheduling checkout.</em>',
  ...
  bomconsorcio:{
    ...
    ttl:'Refazendo o fluxo de venda de cotas:<br><em>de 6 parágrafos jurídicos a um digest, sem perder compliance.</em>',
    ...
    en:{
      ...
      ttl:'Rebuilding the quota sale flow:<br><em>from 6 legal paragraphs to a digest, without losing compliance.</em>',
      meta:['Product Designer','BomConsórcio · Fintech','Figma'],
  ...
  itau:{
    ...
    ttl:'Adaptando um Design System de fintech<br><em>pra white label bancário, com 80%+ de reuso.</em>',
    ...
    en:{
      ey:'White Label · Design System · Fintech',
      ttl:'Adapting a fintech Design System<br><em>for bank white label, with 80%+ reuse.</em>',
      meta:['Product Designer','BomConsórcio × Itaú · Fintech','Figma'],
  ...
  passaporte:{
    ...
    ttl:'Um fluxo conversacional pro cadastro familiar,<br><em>unificando 4 métodos de pagamento entre dois sistemas.</em>',
    ...
    en:{
      ...
      ttl:'A conversational flow for family signup,<br><em>unifying 4 payment methods across two systems.</em>',
      meta:['Product Designer','Kivid · HealthTech · Fintech','Figma'],
