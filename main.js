...
const CASES={
  wellhub:{
    ...
    role:'Product Designer responsável de ponta a ponta: discovery, pesquisa com usuários (benchmark + testes de usabilidade moderados), wireframes, prototipagem de alta fidelidade e validação com 5 usuários reais. Case autoral sem vínculo formal com a empresa.',
  ...
  itau:{
    ...
    role:'Product Designer responsável pela white label completa do fluxo BomConsórcio para o Itaú. Mapeei a jornada do usuário de ponta a ponta (PF e PJ, desktop e app), conduzi prototipagem de baixa e alta fidelidade no Figma para validar com o time de branding do Itaú antes de avançar, e construí um mini design system com design tokens pra garantir consistência visual e handoff para desenvolvimento sem retrabalho. Colaboração direta com PM, PO, engenharia e responsável por branding do Itaú em metodologia ágil. IA generativa (Claude) usada como ferramenta ativa no processo de documentação e estruturação.',
    ...
    +'<h3 style="margin-top:56px">Documentando e organizando o design system</h3><div class="ch-sol-cards ch-sol-cards-3x2"><div class="ch-sol-card"><div class="ch-sol-card-num">01</div><div class="ch-sol-card-title">Diagnóstico antes de editar</div><div class="ch-sol-card-desc">Antes de mudar qualquer componente, mapeei o mini design system que já existia: 9 peças sem descrição, sem anotação de estado, e duas com nomes genéricos que não diziam nada sobre o que mudava entre uma variante e outra.</div></div><div class="ch-sol-card"><div class="ch-sol-card-num">02</div><div class="ch-sol-card-title">Nome certo por confirmação, não suposição</div><div class="ch-sol-card-desc">Em vez de assumir o que "State2" ou "State3" significavam, comparei a diferença visual real entre as variantes, cor de fundo, cor do texto, e só apliquei o nome novo depois de confirmar. Design system errado por suposição é pior que design system sem nome.</div></div><div class="ch-sol-card"><div class="ch-sol-card-num">03</div><div class="ch-sol-card-title">Um erro técnico escondido</div><div class="ch-sol-card-desc">Duas variantes do campo de texto tinham o mesmo nome, quebrando a leitura de propriedades no Dev Mode. O padrão de posição no set, faltava exatamente o par Ativo + Mobile, confirmou que era erro de digitação, não uma variante de propósito.</div></div><div class="ch-sol-card"><div class="ch-sol-card-num">04</div><div class="ch-sol-card-title">Cor solta virou token</div><div class="ch-sol-card-desc">A paleta inteira existia só como referência visual, sem nenhuma Variable de verdade. Criei a coleção de cor no Figma, marca, neutros e texto, e reapliquei em mais de 500 elementos que antes usavam cor fixa direto no fill.</div></div><div class="ch-sol-card"><div class="ch-sol-card-num">05</div><div class="ch-sol-card-title">Documentação em dois lugares</div><div class="ch-sol-card-desc">Anotação que só aparece no Dev Mode não ajuda quem abre o arquivo no modo normal. Cada variante ganhou legenda técnica no Dev Mode e legenda visível direto no canvas, sem depender de nenhuma das duas sozinha.</div></div><div class="ch-sol-card"><div class="ch-sol-card-num">06</div><div class="ch-sol-card-title">Organização pelo padrão real</div><div class="ch-sol-card-desc">Meu primeiro instinto foi empilhar tudo em ordem lógica. Antes de aceitar isso como certo, chequei se era assim que design systems de referência se organizam. Não era. Reorganizei pelo Atomic Design, Foundations, Atoms, Molecules, Organisms, Templates, o mesmo modelo usado por Google e Atlassian, e consolidei as 3 fontes misturadas no arquivo, uma delas licenciada e sem nem carregar em todo ambiente, numa família só.</div></div></div><div class="ch-sol-aside"><div class="ch-sol-aside-label">O raciocínio por trás da ordem</div><p>Resolvi do mais simples pro mais complexo de propósito. Renomear um estado errado é rápido e mostra progresso na hora. Migrar quinhentos elementos pra token, ou trocar fonte em cento e noventa lugares, é arriscado se as decisões pequenas antes ainda não tiverem validadas. Cada gap resolvido virou confiança pro próximo, e o arquivo saiu documentado, auditado e pronto pra virar tokens.json exportável pro time de dev.</p></div></div>',
    resultsLabel:'Resultados',
    ...
    en:{
      ...
      sol:'<div class="ch-sol-cards"><div class="ch-sol-card"><div class="ch-sol-card-num">01</div><div class="ch-sol-card-title">Brand tokenization</div><div class="ch-sol-card-desc">Color, typography, logo and header icons were isolated into a theme layer, pluggable on top of BomConsórcio\'s flow architecture, without touching the signup, offer or identity verification logic.</div></div><div class="ch-sol-card"><div class="ch-sol-card-num">02</div><div class="ch-sol-card-title">Header and navigation with its own identity</div><div class="ch-sol-card-desc">Itaú\'s logo, orange palette and adapted microcopy ("Consórcio Itaú") replaced BomConsórcio\'s equivalents across every touchpoint, from login to the "no offer available" screen.</div></div><div class="ch-sol-card"><div class="ch-sol-card-num">03</div><div class="ch-sol-card-title">Partnership landing page</div><div class="ch-sol-card-desc">A dedicated page with "How it works," reasons to sell through BomConsórcio, and an FAQ, built to legitimize the banking partnership before the client even entered the sale flow.</div></div><div class="ch-sol-card"><div class="ch-sol-card-num">04</div><div class="ch-sol-card-title">White label mini design system</div><div class="ch-sol-card-desc">I built a mini design system covering both environments (external and internal), desktop and app, individual and business clients, brand tokens, form components, error and success states, sustaining the entire mapped journey without screen-by-screen rework.</div></div></div><div class="ch-sol-aside"><div class="ch-sol-aside-label">The most negotiated decision</div><p>At every approval round, Itaú\'s branding team asked for fine adjustments, the exact shade of orange, the header\'s font weight, the logo\'s minimum clear space. Each round-trip ate into days the partnership\'s timeline hadn\'t budgeted for. The fix wasn\'t negotiating fewer rounds, it was getting ahead of them: I pulled Itaú\'s brand manual before drawing the first screen and validated low-fidelity prototypes directly with the branding lead, only moving to high fidelity afterward. That didn\'t eliminate approval rounds, but it cut rework in each one, protecting the partnership\'s tight deadline.</p></div>'
        +'<h3 style="margin-top:56px">Documenting and organizing the design system</h3><div class="ch-sol-cards ch-sol-cards-3x2"><div class="ch-sol-card"><div class="ch-sol-card-num">01</div><div class="ch-sol-card-title">Diagnosis before editing anything</div><div class="ch-sol-card-desc">Before touching a single component, I mapped the mini design system that already existed: 9 pieces with no description, no state annotation, and two with generic names that said nothing about what actually changed between variants.</div></div><div class="ch-sol-card"><div class="ch-sol-card-num">02</div><div class="ch-sol-card-title">Correct naming by confirmation, not assumption</div><div class="ch-sol-card-desc">Instead of guessing what "State2" or "State3" meant, I compared the real visual difference between variants, background color, text color, and only applied the new name after confirming it. A design system named wrong by assumption is worse than one with no name at all.</div></div><div class="ch-sol-card"><div class="ch-sol-card-num">03</div><div class="ch-sol-card-title">A hidden technical error</div><div class="ch-sol-card-desc">Two variants of the text field shared the exact same name, breaking property reading in Dev Mode. The position pattern in the set, missing exactly the Active plus Mobile pair, confirmed it was a typo, not an intentional variant.</div></div><div class="ch-sol-card"><div class="ch-sol-card-num">04</div><div class="ch-sol-card-title">Loose color became a token</div><div class="ch-sol-card-desc">The whole palette existed only as a visual reference, with no real Variable behind it. I created the color collection in Figma, brand, neutrals and text, and reapplied it across more than 500 elements that previously used a fixed color straight in the fill.</div></div><div class="ch-sol-card"><div class="ch-sol-card-num">05</div><div class="ch-sol-card-title">Documentation in two places</div><div class="ch-sol-card-desc">An annotation that only shows up in Dev Mode doesn\'t help whoever opens the file in normal mode. Every variant got a technical caption in Dev Mode and a visible caption right on the canvas, without depending on either one alone.</div></div><div class="ch-sol-card"><div class="ch-sol-card-num">06</div><div class="ch-sol-card-title">Organized by the real standard</div><div class="ch-sol-card-desc">My first instinct was to stack everything in logical order. Before accepting that as correct, I checked whether that\'s actually how reference design systems organize themselves. It wasn\'t. I reorganized using Atomic Design, Foundations, Atoms, Molecules, Organisms, Templates, the same model used by Google and Atlassian, and consolidated the file\'s three mixed fonts, one of them licensed and not even loading in every environment, into a single family.</div></div></div><div class="ch-sol-aside"><div class="ch-sol-aside-label">The reasoning behind the order</div><p>I solved things from simplest to most complex on purpose. Renaming one wrong state is fast and shows progress right away. Migrating five hundred elements to tokens, or swapping fonts in a hundred and ninety places, is risky if the smaller decisions before it haven\'t been validated yet. Each resolved gap became confidence for the next one, and the file came out documented, audited, and ready to become an exportable tokens.json for the dev team.</p></div></div>',
      resultsLabel:'Results',
      results:[
