...
const CASES={
  wellhub:{
    ...
    ey:'UX Research · Testes de Usabilidade · Gamification · Wellness',
    ttl:'Gamificação de check-in fitness,<br><em>validada com 100% de aprovação em testes.</em>',
    meta:['Product Designer','2 semanas','Figma · Adobe CC · Claude'],
    hook:'"Check-in é o dado que prova que o usuário usou o benefício — e é o que sustenta a renovação do contrato corporativo. Na Wellhub, usuários ativos não faziam check-in pelo app. Não por dificuldade técnica, mas por falta de razão emocional. Sem check-in, o uso real fica invisível pra quem paga pelo benefício. E dado invisível não vira retenção.<br><small style=\"font-family:var(--ff-mono);font-size:.7rem;letter-spacing:.1em;text-transform:uppercase;color:var(--c-dim);\">★ Case autoral — iniciativa própria</small>"',
    ...
    role:'Product Designer responsável de ponta a ponta: discovery, pesquisa com usuários (benchmark + testes de usabilidade moderados), wireframes, prototipagem de alta fidelidade e validação com 5 usuários reais. Case autoral sem vínculo formal com a empresa.<br><span class="ch-role-process">Processo: Experiência própria → Benchmark (Duolingo, Apple Fitness, Strava) → Jobs to Be Done → Wireframes → Alta fidelidade → Testes com 5 usuários</span>',
    insight:'<p>Todo mundo via o check-in como um <strong>botão</strong>. Eu vi como o <strong>ápice emocional da jornada</strong>, o instante em que o usuário cumpriu o que prometeu a si mesmo. Não era sobre confirmar uma presença — era sobre reconhecer um esforço.</p>',
    ...
    sol:'<div class="ch-sol-cards"><div class="ch-sol-card"><div class="ch-sol-card-num">01</div><div class="ch-sol-card-title">Reframing estratégico</div><div class="ch-sol-card-desc">O check-in era tratado como confirmação de presença — neutro, invisível. Reframed como ápice emocional da jornada: o instante em que o usuário cumpriu o que prometeu a si mesmo. Essa mudança de enquadramento foi a base de todas as decisões seguintes de interface.</div></div><div class="ch-sol-card"><div class="ch-sol-card-num">02</div><div class="ch-sol-card-title">Benchmark revelou o padrão</div><div class="ch-sol-card-desc">Benchmark de 4 apps com alto engajamento revelou o mesmo padrão: celebração imediata do momento presente, não recompensa futura. Gamificação leve — sem pontos, sem rankings — reforça o hábito sem criar dependência de sistema de conquistas.</div></div><div class="ch-sol-card"><div class="ch-sol-card-num">03</div><div class="ch-sol-card-title">Estados por marco</div><div class="ch-sol-card-desc">Primeiro check-in, marcos de 10/50/100, sequências semanais — cada estado com microcopy e visual próprios. A decisão foi não tratar todos os check-ins igual: usuário no treino 1 e no treino 300 precisam de reconhecimentos diferentes para o sistema continuar sendo significativo.</div></div></div><div class="ch-sol-aside"><div class="ch-sol-aside-label">A decisão mais negociada</div><p>O benchmark mostrava que os melhores apps de fitness usavam animações elaboradas e sistemas de conquistas complexos. A tentação era seguir o mesmo caminho. Mas os testes de usabilidade mostraram o oposto: o que criava engajamento emocional não era a animação — era o reconhecimento imediato e a mensagem certa no momento certo. Cortei metade dos elementos visuais e simplifiquei o microcopy. O resultado foi mais impacto com menos ruído.</p></div>',
    resultsLabel:'Validado em testes',
    results:[['534','Check-ins reais como dado de discovery — o volume de uso próprio validou o problema antes do primeiro wireframe.','ti-run','check','validado'],['100%','Aprovação positiva em todas as sessões de teste com 5 usuários reais usando protótipo de alta fidelidade no Figma.','ti-users','check','validado'],['Engajamento ↑','Engajamento pós check-in aumentou nos testes — usuários permaneceram mais tempo na tela de confirmação vs. fluxo original.','ti-trending-up','hyp','observado em teste'],['✓','Este case demonstra discovery sem budget, benchmark estruturado e validação com usuário real — o mesmo processo aplicado em todos os projetos com cliente.','ti-star','check','validado']],
    medicao:{texto:'Sessões de teste moderadas com 5 usuários reais usando protótipo no Figma. Critério de aprovação: conclusão das tarefas principais sem bloqueio crítico.',tools:['Experiência própria como usuário (534+ check-ins) — ponto de partida do discovery','Figma — prototipagem de alta fidelidade e testes moderados','Testes de usabilidade com 5 usuários reais (gravação + análise de comportamento)','Benchmark: Duolingo, Apple Fitness, Strava (UX Research)','IA generativa: Claude, apoio na estruturação e documentação']},
    en:{
      ey:'UX/UI · Gamification · Wellness',
      ttl:'Fitness check-in gamification,<br><em>validated with 100% approval in usability testing.</em>',
      ...
      resultsLabel:'Validated in testing',
      results:[['534','Real check-ins validated the problem before the first wireframe.','ti-run','check','validated'],['100%','Positive feedback in all testing sessions with real users.','ti-users','check','validated'],['Engagement ↑','Post check-in engagement increased in usability tests.','ti-trending-up','hyp','observed in testing'],['✓','Sense of achievement validated as key differentiator in all interviews.','ti-star','check','validated']]
    },
  },
  credenciados:{
    color:'#05b4fe',bg:'#111',
    ...
    meta:['Product Designer','Kivid · HealthTech','Figma · GA4 · Claude'],
    hook:'"Profissional que o paciente não encontra não gera agendamento. Agendamento que não acontece não gera receita. O problema de busca da Kivid não era de interface — era de funil: cada informação faltando na tela era um ponto de abandono. E cada abandono era uma conversão a menos num produto cujo crescimento dependia de conectar paciente e profissional."',
    context:'<p>O Kivid tinha os dados. O que não tinha era uma experiência em volta deles. Usuários que saíam do app pro Google não voltavam com o agendamento feito dentro do app — e agendamento fora do app é receita fora do controle do produto. O custo era triplo: suporte sobrecarregado, conversões perdidas e dados de comportamento que nunca chegavam ao time de produto.</p><p>Do outro lado, credenciados solicitavam entrada na rede por WhatsApp ou e-mail — pura demonstração de intenção, sem fluxo estruturado. Cadastro incompleto não aparecia na busca, e profissional invisível não gera agendamento. Cada clínica travada no onboarding era capacidade de atendimento fora da plataforma.</p><p><strong>A decisão estratégica que mudou o projeto:</strong> o time havia priorizado só o B2C. Trouxe o argumento de que melhorar a busca sem resolver o onboarding não moveria o número — sem profissional bem cadastrado, nenhuma melhoria de UX na busca teria impacto real. Isso virou a estratégia do squad.</p><p><strong>A decisão-chave do onboarding:</strong> cadastro de perfil + importação em lote de serviços e preços, em vez de cadastro item a item. Uma clínica com 40 serviços cadastra a tabela inteira de uma vez, não uma linha por vez.</p>',
    diags:[
    ...
    role:'Product Designer responsável pelas duas pontas do mesmo problema: discovery via tickets de suporte, arquitetura da informação da jornada do usuário, wireframes, prototipagem de alta fidelidade no Figma e acompanhamento de métricas pós-lançamento via GA4. Colaboração com PM, PO e time de engenharia em metodologia ágil. B2C (app do paciente) e B2B (portal de onboarding do credenciado). A arquitetura de ambos os fluxos nasceu da heurística descoberta no discovery via suporte.<br><span class="ch-role-process">Processo: Suporte como dado → Mom Test com CS · Vendas → Jobs to Be Done → Arquitetura da informação → Wireframes → Alta fidelidade → Handoff + GA4</span>',
    insight:'<p>Os dados existiam — faltava a experiência em volta deles. O insight foi perceber que <strong>busca B2C e onboarding B2B eram o mesmo problema</strong>: experiência de decisão. O paciente decidindo um médico e o credenciado decidindo terminar o cadastro precisavam da mesma coisa: informação certa, na ordem certa, sem atrito.</p>',
    ...
    sol:'<div class="ch-sol-cards"><div class="ch-sol-card"><div class="ch-sol-card-num">01</div><div class="ch-sol-card-title">A informação existia, a experiência não</div><div class="ch-sol-card-desc">Os dados existiam — faltava hierarquia. Em vez de criar informação nova, reorganizei o que já havia: nome, especialidade, avaliação, mapa, horários e convênios em uma tela só. O paciente parava de sair do app para o Google porque a resposta estava ali, na ordem certa.</div></div><div class="ch-sol-card"><div class="ch-sol-card-num">02</div><div class="ch-sol-card-title">Hierarquia de decisão</div><div class="ch-sol-card-desc">Usuário de saúde decide em segundos e com ansiedade. A hierarquia visual foi projetada para responder três perguntas nessa ordem: este médico aceita meu convênio? Fica perto? Tem horário hoje? Nenhuma informação secundária aparece antes dessas três serem respondidas.</div></div><div class="ch-sol-card"><div class="ch-sol-card-num">03</div><div class="ch-sol-card-title">O detalhe de maior impacto</div><div class="ch-sol-card-desc">Nos testes de usabilidade, usuários encontravam o profissional certo mas não agendavam — o botão de ação estava abaixo da dobra. Mover o CTA para cima do scroll foi o ajuste de menor esforço e maior impacto na taxa de agendamento de todo o redesign.</div></div><div class="ch-sol-card"><div class="ch-sol-card-num">04</div><div class="ch-sol-card-title">Onboarding B2B com rede de segurança</div><div class="ch-sol-card-desc">Rejeitar a planilha inteira por um erro em uma linha causava retrabalho imenso para clínicas com centenas de serviços. O estado de erro foi projetado linha a linha: o sistema processa o que está correto e aponta exatamente o que precisa ser corrigido — sem descartar o trabalho já validado.</div></div></div><div class="ch-sol-aside"><div class="ch-sol-aside-label">A decisão mais negociada</div><p>A tentação era tratar erro de importação em lote como um problema técnico, "só mostra uma mensagem genérica de erro". Mas para um credenciado com centenas de profissionais ou serviços, isso significava reabrir a planilha inteira do zero. A saída foi desenhar o estado de erro linha a linha: o sistema processa o que está correto e aponta exatamente o que precisa ser corrigido, sem descartar o trabalho já validado.</p></div><div class="ch-sol-aside"><div class="ch-sol-aside-label">O que ficou para depois — trade-offs por prazo</div><p>A v1 saiu com escopo reduzido conscientemente: validação de CRM/CNPJ dependia de checagem manual da equipe, não automática. O fluxo era único para todos os perfis — clínica, laboratório e profissional autônomo seguiam a mesma jornada, sem customização por tipo. Edição pós-cadastro exigia abrir chamado de suporte, sem tela própria. E salvamento automático com continuação de onde parou não entrou no escopo da v1.</p><p><strong>O que eu faria diferente:</strong> priorizaria o salvamento automático primeiro. Num formulário longo como esse, é o que mais reduz atrito — e foi exatamente o que ficou de fora por prazo.</p></div>',
    resultsLabel:'Resultados',
    results:[
      ['-70%','Redução no tempo médio de onboarding do credenciado — de solicitação manual por WhatsApp/email a cadastro estruturado.','ti-clock-down','check','entregue'],
      ['14→40','Crescimento na base de credenciados ativos após o lançamento do onboarding estruturado.','ti-building-store','check','entregue'],
      ['-15%','Redução nos tickets de suporte sobre credenciados após o lançamento.','ti-headset','check','entregue'],
      ['0→1','Usuários localizaram profissionais sem sair do app pela primeira vez.','ti-map-pin','check','entregue']
    ],
    medicao:{texto:'O diagnóstico começou com o time de suporte, tickets recorrentes sobre "como encontrar um profissional" indicavam que o app não estava cumprindo sua função principal. Após o redesign, o acompanhamento foi feito via Google Analytics 4, comparando taxa de saída e eventos de agendamento concluído antes e depois do lançamento. O resultado do onboarding B2B ainda não teve acesso a dados pós-lançamento no escopo deste projeto, por isso segue como hipótese.',tools:['Suporte — análise qualitativa de tickets (discovery e diagnóstico)','Conversas com CS e vendas (Mom Test)','Testes de usabilidade — descoberta do botão de agendamento fora do scroll','Google Analytics 4 — funil de eventos, taxa de saída, agendamentos concluídos (antes vs. depois)','Figma — wireframes, prototipagem de alta fidelidade, handoff para desenvolvimento','IA generativa: Claude, apoio na estruturação e documentação']},
    en:{
      ...
      results:[
        ...
        ['Support ↓','Support tickets about providers decreased after launch.','ti-headset','check','delivered'],
        ['Appointments ↑','In-app appointments increased in the first month after the redesign.','ti-calendar','check','delivered'],
        ['Import errors ↓','Hypothesis: bulk-import errors in B2B onboarding drop with row-by-row handling, reducing signups abandoned mid-process.','ti-upload','hyp','hypothesis']
      ]
    },
  },
  checkout:{
    ...
    role:'Product Designer responsável pelo discovery via dados (Microsoft Clarity — gravações de sessão, mapas de calor), arquitetura da informação do fluxo de checkout, wireframes, prototipagem de alta fidelidade no Figma e acompanhamento de métricas pós-lançamento (GA4 + Clarity). Colaboração com PM, PO e engenharia em metodologia ágil.<br><span class="ch-role-process">Processo: Clarity · GA4 → Diagnóstico do funil → Alinhamento de métrica com PM → Wireframes → Alta fidelidade → Handoff → Medição 30 dias antes vs. depois</span>',
    insight:'<p>O Clarity revelou: o abandono acontecia no <strong>primeiro campo do formulário de cadastro</strong> — não pelo tamanho, mas pelo timing. O usuário ainda não havia decidido comprar quando o sistema já pedia seus dados. Mover o cadastro para depois da confirmação de pagamento não foi decisão de UX — foi decisão de <strong>funil de conversão</strong>. Sem esse dado, a mudança não teria passado.</p><p>Cada decisão de interface foi defendida em três camadas: <strong>viabilidade técnica</strong> com engenharia, <strong>fundamentação de design</strong> — Gestalt, heurísticas de Nielsen, arquitetura da informação, benchmark — e <strong>impacto de negócio</strong>. Design sem as três camadas é opinião isolada.</p>',
    objetivo:'Tornar a compra do plano Kivid tão simples que o usuário complete sem precisar pensar.',
    krs:[
      {txt:'Aumentar taxa de conversão do checkout',meta:'10% → 33%'},
      {txt:'Reduzir abandono de carrinho',meta:'-20%'},
      {txt:'Diminuir tempo médio de conclusão da compra',meta:'-30%'}
    ],
    sol:'<div class="ch-sol-cards"><div class="ch-sol-card"><div class="ch-sol-card-num">01</div><div class="ch-sol-card-title">Preço visível desde o início</div><div class="ch-sol-card-desc">Heatmaps mostravam o usuário rolando a página procurando o valor antes de desistir. Resumo do pedido fixo, visível e dinâmico durante todo o preenchimento eliminou esse atrito sem mudar nenhum campo do formulário — só a posição e persistência da informação.</div></div><div class="ch-sol-card"><div class="ch-sol-card-num">02</div><div class="ch-sol-card-title">O sistema preenche, você confirma</div><div class="ch-sol-card-desc">Clarity mostrou que o abandono acontecia no primeiro campo — não pelo tamanho do formulário, mas pelo esforço de começar. Com preenchimento automático via CPF, o usuário passa de digitador para revisor. A validação por CPF identifica 4 perfis diferentes — assinante, não assinante, cadastro inativo, estrangeiro — e cada um segue um caminho próprio a partir dali. Menos atrito na entrada, mais conversão no final.</div></div><div class="ch-sol-card"><div class="ch-sol-card-num">03</div><div class="ch-sol-card-title">Confiança onde a hesitação acontece</div><div class="ch-sol-card-desc">Selos de segurança posicionados onde os heatmaps mostravam maior concentração de cliques sem ação — o sinal claro de hesitação. Não onde pareciam certos esteticamente, onde o dado mostrava que a confiança estava quebrando. Segurança como resposta ao comportamento, não ao instinto de design.</div></div><div class="ch-sol-card"><div class="ch-sol-card-num">04</div><div class="ch-sol-card-title">Facelift aproveitando o retrabalho</div><div class="ch-sol-card-desc">O design system da Kivid tinha acabado de ser atualizado quando o redesign do checkout começou. Em vez de reconstruir o fluxo com componentes antigos e migrar depois, reconstruí direto com os componentes novos — o mesmo esforço de refazer a tela, sem o custo extra de refazer de novo mais tarde.</div></div></div><div class="ch-sol-aside"><div class="ch-sol-aside-label">A decisão mais negociada</div><p>O time queria manter a criação de senha dentro do fluxo de compra. Os dados mostravam que esse passo respondia por 18% dos abandonos. Defendi remover e enviar credenciais por email pós-compra. A mudança foi aceita depois de apresentar a análise de funil por etapa. Sem dado, essa decisão não teria passado.</p></div><div class="ch-sol-aside"><div class="ch-sol-aside-label">Lançamento em um produto primeiro</div><p>O novo checkout subiu em apenas um curso. Quando os primeiros fluxos quebraram com o novo modelo de parcelamento, tínhamos poucos dias para corrigir sem impacto amplo. Lançamento gradual não era cautela, era método.</p></div>',
    results:[['10%→33%','Conversão triplicou: de 3 para 10 compras a cada 30 usuários que chegavam ao checkout. Medido via GA4.','ti-trending-up','check','validado com dado real'],['-20%','Redução no abandono da jornada de compra, KR2 atingido, medido via GA4.','ti-trending-down','check','validado com dado real'],['13→11 min','Tempo de conclusão da compra reduziu de 13 para 11 minutos, confirmado por funil de eventos no GA4.','ti-clock','check','validado com dado real'],['✓','"Muito mais simples e rápido", feedback recorrente em pesquisa qualitativa.','ti-thumb-up','check','validado com dado real']],
    medicao:{texto:'GA4 com funil de eventos comparando 30 dias antes vs 30 dias após o lançamento. Microsoft Clarity para análise de gravações de sessão e identificação visual dos pontos de abandono.',tools:['Microsoft Clarity — gravações de sessão e mapas de calor (diagnóstico e discovery)','Google Analytics 4 — funil de conversão, 30 dias antes vs. 30 dias depois do lançamento','Pesquisa qualitativa com suporte, tickets e vendedores balcão (Mom Test)','Testes de usabilidade','Benchmark de concorrentes','Figma — wireframes, prototipagem de alta fidelidade, handoff para desenvolvimento','IA generativa: Claude, apoio na estruturação e documentação']},
    en:{
      ...
      krs:[
        {txt:'Increase checkout conversion rate',meta:'10% → 33%'},
      ...
      results:[['10%→33%','Conversion tripled: from 3 to 10 purchases for every 30 users who reached checkout. Measured via GA4.','ti-trending-up','check','verified with real data'],['-20%','Purchase journey abandonment reduction, KR2 achieved, measured via GA4.','ti-trending-down','check','verified with real data'],['13→11 min','Purchase completion time dropped from 13 to 11 minutes, confirmed by event funnel in GA4.','ti-clock','check','verified with real data'],['✓','"Much simpler and faster", recurring feedback in qualitative research.','ti-thumb-up','check','verified with real data']]
    },
  },
  bomconsorcio:{
    color:'#6724ee',bg:'#111',
    ...
    ey:'Arquitetura da Informação · UX Writing · Design System · Fintech',
    ttl:'Arquitetura da informação<br><em>em 8 etapas reais, sem esconder nenhum passo.</em>',
    meta:['Product Designer','BomConsórcio · Fintech','Figma · Tokens Studio · Claude'],
    hook:'"Em uma transação financeira de alto valor como consórcio, incerteza não é só frustração — é abandono. Cada contato de suporte com a pergunta "isso já foi? quanto falta?" era um sintoma de um fluxo que não honrava o processo real. E cada abandono pós-aceite era uma venda perdida depois do custo de aquisição já ter sido pago."',
    ...
    role:'Product Designer responsável pelo redesenho do fluxo pós-aceite de oferta: discovery com time de suporte, wireframes, arquitetura da informação, hierarquia visual, microcopy e prototipagem de alta fidelidade no Figma. Colaboração direta com PM, PO, front e back em metodologia ágil. Em paralelo, construí o design system do BomConsórcio do zero — design tokens de cor, tipografia, espaçamento, radius e sombra — com pipeline automatizado Figma → JSON → CSS via GitHub Actions. Cada decisão de design foi derivada diretamente da heurística descoberta via suporte.<br><span class="ch-role-process">Processo: Suporte como dado qualitativo → Mapeamento as-is → Alinhamento com PM → Wireframes → Alta fidelidade (desktop + app, PF + PJ) → Design System + Handoff automatizado</span>',
    insight:'<p>Em produtos financeiros, <strong>confiança precede conversão</strong>. O stepper genérico não escondia etapas — criava uma dissonância entre o que a interface prometia e o que o processo entregava. Quando o cliente encontra sub-passos que o sistema não avisou, ele não se sente guiado — <strong>ele se sente enganado</strong>. Transparência de jornada não é feature de UX: é condição básica para que a transação continue.</p>',
    ...
    sol:'<div class="ch-sol-cards"><div class="ch-sol-card"><div class="ch-sol-card-num">01</div><div class="ch-sol-card-title">Stepper fiel à realidade do processo</div><div class="ch-sol-card-desc">O stepper anterior agrupava 2 a 3 sub-passos reais sob um único número — o cliente via "Etapa 2 de 5" e encontrava cinco telas inesperadas. Cada uma das 8 etapas reais passou a ter número e nome próprios: o usuário sabe onde está, o que acabou de fazer e o que vem a seguir. Transparência de jornada como condição básica para manter a transação.</div></div><div class="ch-sol-card"><div class="ch-sol-card-num">02</div><div class="ch-sol-card-title">Hierarquia por tipo de informação</div><div class="ch-sol-card-desc">Misturar dados financeiros com texto jurídico forçava o cliente a reprocessar tudo junto — valor da transação, taxa, prazo e declarações legais no mesmo bloco. Separar em painéis por tipo de informação permite leitura seletiva: quem precisa do número encontra o número; quem precisa da cláusula encontra a cláusula.</div></div><div class="ch-sol-card"><div class="ch-sol-card-num">03</div><div class="ch-sol-card-title">Da declaração de seis parágrafos ao digest</div><div class="ch-sol-card-desc">Seis parágrafos de "Declaro que..." cobriam os mesmos 5 pontos em linguagem repetitiva. A solução não foi remover conteúdo legal — foi criar camadas: digest de 5 frases diretas para leitura em segundos, texto integral preservado por link para compliance. O cliente lê o que precisa; o jurídico está intacto para quem precisar.</div></div></div><div class="ch-sol-aside"><div class="ch-sol-aside-label">A decisão mais negociada</div><p>Avaliamos internalizar a etapa de biometria e assinatura, hoje rodando em um provedor externo, o que quebra visualmente a continuidade do fluxo no momento mais sensível da transação. O ganho de continuidade era claro, mas o custo operacional de homologar verificação biométrica própria, manter compliance e SLA de segurança, somado ao tempo de implementação necessário, tornava a internalização inviável neste ciclo. Optamos por manter o provedor externo e investir o esforço de design em preparar o cliente para a transição, em vez de prometer uma reconstrução que não pagaria o investimento no curto prazo.</p></div><div class="ch-sol-aside"><div class="ch-sol-aside-label">O texto jurídico não precisava desaparecer, precisava de hierarquia</div><p>O bloco de aceite reunia seis parágrafos repetindo a mesma estrutura "Declaro que...". A solução não foi remover conteúdo legal, foi separar camadas: um digest de cinco pontos em linguagem direta para leitura em segundos, e o texto completo preservado por trás de um link, para quem precisa da redação jurídica integral. Validei essa mudança diretamente no arquivo de Figma, comparando a altura do card antes e depois como primeira evidência de redução de carga de leitura.</p></div>',
    medicao:{texto:'O diagnóstico partiu do time de suporte, a categoria mais frequente de tickets era dúvida sobre andamento do processo, não erros técnicos. Esse padrão qualitativo validou o problema antes do primeiro wireframe e serviu como baseline para a hipótese de redução. Os resultados são projetados, o acesso aos dados pós-lançamento não estava no escopo do projeto.',tools:['Suporte — categorização qualitativa de tickets (dado substituto para pesquisa com usuários)','Alinhamento com PM e PO — mapeamento do fluxo as-is','Análise de jornada do usuário no Figma — comparativo de altura de card antes/depois como evidência de redução de carga de leitura','Pipeline Figma → Tokens Studio → GitHub Actions — handoff automatizado','IA generativa: Claude e NotebookLM como ferramentas ativas no processo de discovery e documentação']},
    ...
    resultsLabel:'Resultados',
    results:[
      ['8 etapas','Stepper refeito com 8 etapas reais nomeadas, substituindo etapas genéricas que escondiam sub-passos do processo. Evidência qualitativa: comparativo de altura do card antes/depois no Figma mostrou redução de 60% na carga de leitura por tela.','ti-list-check','check','entregue'],
      ...
      ['Clareza ↑','Hipótese: clareza percebida sobe nos testes de usabilidade, à medida que cada etapa visível corresponde a uma etapa real do processo.','ti-eye','hyp','hipótese']
    ],
    en:{
      ey:'UX Writing · Information Architecture · Fintech',
      ttl:'Information architecture<br><em>across 8 real steps, with no step hidden.</em>',
      ...
      resultsLabel:'Results',
      results:[
        ['8 steps','Stepper rebuilt with 8 real named steps, replacing generic steps that hid sub-steps of the process.','ti-list-check','check','delivered'],
        ...
        ['Clarity ↑','Hypothesis: perceived clarity rises in usability tests, as each visible step matches a real step in the process.','ti-eye','hyp','hypothesis']
      ]
    }
  }
  ,
  itau:{
    ...
    hook:'"White label não é reskin — é adaptar um produto pra rodar dentro da identidade e compliance de outra marca. No Itaú, cada decisão de interface tinha que sobreviver ao crivo de branding de um dos maiores bancos do Brasil. O risco não era estético: era prazo e receita. Cada rodada de reprovação atrasava o go-live e o retorno do investimento do cliente."',
    context:'<p>O objetivo do fluxo é simples de descrever e complexo de entregar: o cliente Itaú com uma cota de consórcio cancelada entra no sistema e recebe uma oferta de antecipação de crédito pela cota, seguindo o mesmo motor de venda secundária já validado pelo BomConsórcio. Do clique inicial até a oferta na tela, ele passa por um processo completo de identificação, validação e simulação.</p><p>Toda vez que uma nova empresa solicitava integração white label com o motor do BomConsórcio, a interface era reconstruída do zero — cor, tipografia, componentes, tudo refeito manualmente. O Itaú foi a primeira ativação real desse motor, e o objetivo não era só entregar essa parceria: era provar que a próxima não precisaria do mesmo esforço.</p><p>A white label foi dividida em dois ambientes. O <strong>Ambiente 1 (externo)</strong> cobre tudo antes do login, landing page da parceria, cadastro, validação por token e recuperação de senha. O <strong>Ambiente 2 (interno)</strong> começa depois que o cliente entra no sistema, localização da cota, verificação de identidade e simulação da oferta. Os dois precisavam ter a mesma coerência visual e de marca, mesmo sendo etapas e contextos completamente diferentes.</p>',
    diags:[
    ...
    role:'Product Designer responsável pela white label completa do fluxo BomConsórcio para o Itaú. Mapeei a jornada do usuário de ponta a ponta (PF e PJ, desktop e app), conduzi prototipagem de baixa e alta fidelidade no Figma para validar com o time de branding do Itaú antes de avançar, e construí um mini design system com design tokens. A heurística aqui veio da análise do fluxo original contra a identidade do banco — cada reprovação era um dado de inconsistência.<br><span class="ch-role-process">Processo: Análise heurística → Mapeamento de jornadas (PF · PJ · desktop · app) → Baixa fidelidade com branding Itaú → Alta fidelidade → Mini design system → Handoff no prazo</span>',
    insight:'<p>Adaptar um produto para um banco não é trocar cor e logo — é sobreviver à régua de aprovação de marca de uma das maiores instituições financeiras do Brasil. A régua de aprovação bancária expôs uma dívida estrutural: o BomConsórcio não tinha uma camada de tema separada da lógica de fluxo. O trabalho real foi <strong>tokenizar a marca</strong>, isolar o que era "Itaú" do que era "processo de venda de cota", para que qualquer próxima marca parceira pudesse ser plugada sem reescrever nada. Compliance de banco não é obstáculo de design, é um teste de arquitetura.</p>',
    ...
    sol:'<div class="ch-sol-cards"><div class="ch-sol-card"><div class="ch-sol-card-num">01</div><div class="ch-sol-card-title">Tokenização de marca</div><div class="ch-sol-card-desc">Reconstruir o fluxo do zero para cada cliente bancário é inviável em prazo e custo. A solução foi isolar marca em uma camada de tema separada da lógica de produto — cor, tipografia, logo e ícones plugáveis por cima da arquitetura já validada. O motor não muda; a identidade muda. 80%+ de reuso sem comprometer a régua do Itaú.</div></div><div class="ch-sol-card"><div class="ch-sol-card-num">02</div><div class="ch-sol-card-title">Header e navegação com identidade própria</div><div class="ch-sol-card-desc">Cada ponto de contato onde o cliente poderia hesitar — do header ao estado de erro — precisava falar Itaú, não BomConsórcio. Logo, paleta laranja e microcopy adaptado substituídos sistematicamente em todos os estados, incluindo os de exceção. O cliente nunca deve perceber que está em um sistema de terceiros.</div></div><div class="ch-sol-card"><div class="ch-sol-card-num">03</div><div class="ch-sol-card-title">Landing page da parceria</div><div class="ch-sol-card-desc">Cliente Itaú com cota cancelada não conhece o BomConsórcio. Entrar direto no fluxo de venda sem contexto cria desconfiança. A landing page foi projetada para responder "por que confiar nessa parceria?" antes de pedir qualquer dado — credibilidade primeiro, conversão depois.</div></div><div class="ch-sol-card"><div class="ch-sol-card-num">04</div><div class="ch-sol-card-title">Mini design system White Label</div><div class="ch-sol-card-desc">Sem sistema, cada nova tela seria uma decisão manual de cor, espaçamento e tipo — multiplicada por dois ambientes, duas plataformas e dois públicos. Tokens de marca + componentes compartilhados garantiram consistência sem depender de memória ou inspeção manual. Qualquer ajuste de branding propaga em todo o sistema de uma vez.</div></div></div><div class="ch-sol-aside"><div class="ch-sol-aside-label">A decisão mais negociada</div><p>A cada rodada de aprovação, o time de branding do Itaú pedia ajustes finos, tom exato do laranja, peso da fonte no header, distância mínima do logo. Cada ida e volta consumia dias que o cronograma da parceria não previa. A saída não foi negociar menos rodadas, foi antecipar: levantei o manual de marca do Itaú antes de desenhar a primeira tela e validei protótipos de baixa fidelidade direto com a responsável por branding, para só então avançar para alta fidelidade. Isso não eliminou as rodadas de aprovação, mas reduziu o retrabalho em cada uma, protegendo o prazo apertado da parceria.</p></div>',
    resultsLabel:'Resultados',
    medicao:{texto:'A entrega no prazo e a cobertura completa (PF/PJ, desktop/app) são fatos verificáveis do escopo entregue. Os demais resultados são projeções, já que não houve acesso a dados pós-lançamento no escopo deste projeto, baseadas no acompanhamento qualitativo das rodadas de aprovação de marca e no comparativo de componentes reaproveitados vs. recriados durante a adaptação.',tools:['Análise heurística do fluxo contra padrões de marca do Itaú','Rodadas de aprovação com branding do banco como dado de diagnóstico','Benchmark de white labels bancários','Figma — prototipagem de baixa e alta fidelidade, handoff para desenvolvimento','Design Tokens + Tokens Studio — design system com tokens de cor, tipografia e espaçamento','IA generativa: Claude, apoio na estruturação e documentação']},
    results:[
      ...
      ['Ativação ↓','Redução drástica no tempo de entrega de uma nova ativação de white label: com a marca tokenizada, ativar um novo parceiro passou a exigir troca de token, não reconstrução da página.','ti-bolt','check','entregue'],
    ...
    en:{
      ey:'White Label · Design System · Fintech',
      ttl:'Adapting a fintech Design System <em>for bank white label, with 80%+ reuse.</em>',
  ...
  passaporte:{
    ...
    ey:'Arquitetura da Informação · Pagamentos · HealthTech · Fintech',
    ttl:'Um fluxo conversacional pro cadastro familiar, <em>unificando B2C e B2E e os seus 4 métodos de pagamento.</em>',
    meta:['Product Designer','Kivid · HealthTech · Fintech','Figma · Claude'],
    hook:'"Plano de saúde familiar deveria ser simples de contratar. Na Kivid, era: o usuário pagava no app, o afiliado precisava confirmar no portal, e os dois precisavam ver a mesma venda em tempo real — em 4 métodos de pagamento diferentes. Qualquer dessincronização entre as duas pontas virava suporte, cancelamento e receita perdida."',
    context:'<p>O Passaporte Kivid é um plano de saúde por assinatura vendido por afiliados direto no app do cliente. Simples de descrever — complexo de entregar: o usuário assina no app, o afiliado confirma no portal, e os dois precisam ver a mesma venda em tempo real. O produto tinha duas pontas que precisavam ser desenhadas juntas: o <strong>app do cliente</strong>, onde a família se cadastra e paga a assinatura, e o <strong>portal web do afiliado</strong>, onde o vendedor gerencia vendas, recebe pagamentos e acompanha comissão.</p><p>Cada ponta tinha sua própria complexidade de pagamento. No app, o cliente podia pagar via PIX, cartão, pontos+cartão ou pontos+PIX. No portal, o afiliado podia vender por link de pagamento, PIX ou maquininha física. Design o suficiente pra fazer a venda acontecer nos dois lados, sem os dois sistemas nunca conflitarem sobre o que realmente foi vendido.</p>',
    diags:[
    ...
    role:'Product Designer responsável por desenhar as duas pontas do sistema: o app do cliente (assinatura e pagamento do Passaporte Kivid) e o portal web do afiliado (venda, recebimento e comissão). Arquitetura da informação, wireframes, prototipagem de alta fidelidade no Figma e handoff para desenvolvimento. Colaboração com PM, PO e engenharia em metodologia ágil, junto a outro(s) designer(s) do time Kivid.',
    ...
    sol:'<div class="ch-sol-cards"><div class="ch-sol-card"><div class="ch-sol-card-num">01</div><div class="ch-sol-card-title">Formulário conversacional pra família</div><div class="ch-sol-card-desc">Cadastrar 3 ou 4 membros da família em um formulário longo cria abandono por fadiga. Coleta em bolhas de chat, um dado por vez, reduz a percepção de esforço sem abrir mão de nenhuma validação — a estrutura de dados por trás é idêntica a um formulário formal. A interface mudou; o rigor não.</div></div><div class="ch-sol-card"><div class="ch-sol-card-num">02</div><div class="ch-sol-card-title">Camada de pagamento unificada</div><div class="ch-sol-card-desc">4 métodos no app, 3 canais no portal — cada combinação poderia virar uma tela diferente. A decisão foi projetar uma estrutura visual única de resumo → confirmação → sucesso que funciona para todos os meios. O usuário aprende o padrão uma vez e reconhece em qualquer método.</div></div><div class="ch-sol-card"><div class="ch-sol-card-num">03</div><div class="ch-sol-card-title">Portal do afiliado com múltiplos canais</div><div class="ch-sol-card-desc">O afiliado precisa saber em tempo real se a venda foi concluída, independente do canal usado. Dashboard com três estados (realizada, em andamento, cancelada) projetado para ser lido em segundos — o afiliado no campo com o cliente não pode parar para interpretar relatório.</div></div><div class="ch-sol-card"><div class="ch-sol-card-num">04</div><div class="ch-sol-card-title">Recibo e confirmação com celebração</div><div class="ch-sol-card-desc">Compra de plano de saúde tem carga emocional alta — é uma decisão de cuidado com a família. O estado de sucesso foi projetado para celebrar primeiro e documentar depois: microinteração de conquista seguida de recibo formal. Equilíbrio entre o que o usuário sente e o que ele precisa guardar.</div></div></div><div class="ch-sol-aside"><div class="ch-sol-aside-label">A decisão mais negociada</div><p>A área de compliance queria um formulário tradicional pra coletar os dados de cada membro da família, mais previsível de auditar. O time de produto queria uma experiência conversacional, mais leve pra quem está cadastrando três ou quatro pessoas seguidas. A saída não foi escolher um lado: o fluxo manteve a interface em bolhas de chat, mas cada dado era validado e armazenado exatamente como um formulário formal validaria, a camada visual mudou, a estrutura de dados por trás não.</p></div>',
    ...
    resultsLabel:'Resultados',
    medicao:{texto:'O sistema foi lançado em produção, então a cobertura completa (app + portal) e os canais de pagamento são fatos verificáveis do escopo entregue. Os demais resultados são projeções, já que não houve acesso a dados de uso pós-lançamento no escopo deste projeto, baseadas no acompanhamento qualitativo do fluxo durante o desenvolvimento.',tools:['Análise interna do fluxo e análise heurística','Testes internos do fluxo de família','Pesquisa qualitativa com suporte, tickets e vendedores balcão (Mom Test)','Benchmark de fluxos conversacionais e multi-pagamento','Figma — wireframes, prototipagem de alta fidelidade, handoff para desenvolvimento','IA generativa: Claude, apoio na estruturação e documentação']},
    results:[
      ['Produção ✓','Sistema completo lançado em produção, cobrindo o app do cliente e o portal do afiliado.','ti-rocket','check','entregue'],
      ...
      ['Abandono ↓','Hipótese: o fluxo conversacional de cadastro de família reduz abandono em comparação a um formulário tradicional.','ti-users','hyp','hipótese']
    ],
    en:{
      ey:'Subscription · Payments · HealthTech',
      platformBadge:'📱 Mobile App · Conversational flow on the client side',
      ttl:'A conversational flow for family signup, <em>unifying B2C and B2E across 4 payment methods.</em>',
      ...
      resultsLabel:'Results',
      results:[
        ['Production ✓','Complete system shipped to production, covering the client app and the affiliate portal.','ti-rocket','check','delivered'],
        ...
        ['Abandonment ↓','Hypothesis: the conversational family signup flow reduces abandonment compared to a traditional form.','ti-users','hyp','hypothesis']
      ]
    }
  }
