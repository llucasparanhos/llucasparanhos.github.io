...
const CASES={
  ...
  passaporte:{
    ...
    ttl:'Um fluxo conversacional pro cadastro familiar,<br><em>unificando B2C e B2E em 4 métodos de pagamento.</em>',
    ...
    en:{
      ...
      ttl:'A conversational flow for family signup,<br><em>unifying B2C and B2E across 4 payment methods.</em>',
      meta:['Product Designer','Kivid · HealthTech · Fintech','Figma'],
