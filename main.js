...
const CASES={
  ...
  itau:{
    ...
    results:[
      ...
      ['PF + PJ','Hipótese: cobrir a jornada inteira em desktop e app, para pessoa física e jurídica, reduz retrabalho em ciclos futuros de manutenção e em próximas marcas parceiras.','ti-devices','hyp','hipótese']
    ],
    en:{
      ey:'White Label · Design System · Fintech',
      ...
      results:[
        ...
        ['PF + PJ','Hypothesis: covering the full journey in desktop and app, for individual and business clients, reduces rework in future maintenance cycles and future partner brands.','ti-devices','hyp','hypothesis']
      ]
    }
  }
