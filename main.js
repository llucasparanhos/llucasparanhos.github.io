...
const CASES={
  wellhub:{
    ...
    results:[['534','Check-ins reais validaram o problema antes do primeiro wireframe.','ti-run','check','validado'],['100%','Feedback positivo em todas as sessões de teste com usuários reais.','ti-users','check','validado'],['Engajamento ↑','Engajamento pós check-in aumentou nos testes de usabilidade.','ti-trending-up','hyp','observado em teste'],['✓','Senso de conquista validado como diferencial em todas as entrevistas.','ti-star','check','validado']],
    medicao:{texto:'Sessões de teste moderadas com 5 usuários reais usando protótipo no Figma. Critério de aprovação: conclusão das tarefas principais sem bloqueio crítico.',tools:['Figma — prototipagem de alta fidelidade e testes moderados','Testes de usabilidade com 5 usuários reais (gravação + análise de comportamento)','Benchmark: Duolingo, Apple Fitness, Strava (UX Research)','IA generativa: Claude, apoio na estruturação e documentação']},
    en:{
  ...
  credenciados:{
    ...
    context:'<p>O Kivid tinha os dados. O que não tinha era uma experiência em volta deles. Usuários que saíam do app pro Google não voltavam com o agendamento feito dentro do app — e agendamento fora do app é receita fora do controle do produto. O custo era triplo: suporte sobrecarregado, conversões perdidas e dados de comportamento que nunca chegavam ao time de produto.</p><p>Do outro lado, credenciados com cadastro incompleto não apareciam na busca — e profissional invisível não gera agendamento. Cada clínica travada no onboarding era capacidade de atendimento fora da plataforma.</p><p><strong>A decisão estratégica que mudou o projeto:</strong> o time havia priorizado só o B2C. Trouxe o argumento de que melhorar a busca sem resolver o onboarding não moveria o número — sem profissional bem cadastrado, nenhuma melhoria de UX na busca teria impacto real. Isso virou a estratégia do squad.</p>',
    diags:[
    ...
    results:[
      ...
      ['Suporte ↓','Tickets de suporte sobre credenciados reduziram após o lançamento.','ti-headset','check','entregue'],
      ['Agendamentos ↑','Agendamentos via app aumentaram no primeiro mês após o redesign.','ti-calendar','check','entregue'],
      ['Importação ↓','Hipótese: erros de importação em lote no onboarding B2B caem com o tratamento linha a linha, reduzindo cadastros abandonados no meio do processo.','ti-upload','hyp','hipótese']
    ],
    medicao:{texto:'O diagnóstico começou com o time de suporte, tickets recorrentes sobre "como encontrar um profissional" indicavam que o app não estava cumprindo sua função principal. Após o redesign, o acompanhamento foi feito via Google Analytics 4, comparando taxa de saída e eventos de agendamento concluído antes e depois do lançamento. O resultado do onboarding B2B ainda não teve acesso a dados pós-lançamento no escopo deste projeto, por isso segue como hipótese.',tools:['Suporte — análise qualitativa de tickets (discovery e diagnóstico)','Google Analytics 4 — funil de eventos, taxa de saída, agendamentos concluídos (antes vs. depois)','Figma — wireframes, prototipagem de alta fidelidade, handoff para desenvolvimento','IA generativa: Claude, apoio na estruturação e documentação']},
    en:{
  ...
  checkout:{
    ...
    ttl:'Reduzindo abandono de carrinho em 20% <em>no checkout de agendamentos de saúde.</em>',
    ...
    en:{
      ...
      results:[['+15%','Conversion rate increase, KR1 achieved, measured via GA4.','ti-trending-up','check','verified with real data'],['-20%','Cart abandonment reduction, KR2 achieved, measured via GA4.','ti-shopping-cart','check','verified with real data'],['Purchase time ↓','Average purchase completion time dropped, confirmed by event funnel.','ti-clock','check','verified with real data'],['✓','"Much simpler and faster", recurring feedback in qualitative research.','ti-thumb-up','check','verified with real data']]
    },
  },
  nps:{
    color:'#854F0B',bg:'#111',
    ...
    hook:'"Produto que não escuta o usuário toma decisão no escuro. Na Kivid, o roadmap era definido pelo que gritava mais alto no suporte — não por padrão real de insatisfação. Sem linha de base de NPS, não havia como saber se o produto estava melhorando ou piorando. E sem saber isso, cada sprint era um investimento sem retorno mensurável."',
    context:'<p>Sem dado de satisfação, o time priorizava pelo que gritava mais alto — reclamações isoladas no suporte, não padrões reais. O custo era invisível mas real: sprints planejados sem evidência, melhorias entregues sem como medir se funcionaram, e decisões de produto que poderiam estar indo na direção errada sem ninguém saber.</p><p>Em produto digital, NPS não é vaidade — é sinal de retenção. Cliente insatisfeito que não é ouvido não reclama: cancela. Criar um canal de escuta era criar infraestrutura de dados pra embasar o roadmap com evidência, não com feeling.</p>',
    diags:[
    ...
    role:'Product Designer responsável pela concepção do canal, benchmark, fluxo, microcopy e protótipo. A decisão de cada elemento nasceu da análise heurística do comportamento do usuário e benchmarking de produtos com alto engajamento.<br><span class="ch-role-process">Processo: Discovery interno → Benchmarking (Delighted, Wootric) → Definição do momento de disparo → Wireframes → Alta fidelidade → Handoff para back-end</span>',
    ...
    objetivo:'Criar o primeiro canal de escuta ativa da Kivid — NPS in-app disparado pós-atendimento — atingindo taxa de resposta acima da baseline de mercado para healthtechs nos primeiros 30 dias.',
    krs:[
    ...
    sol:'<div class="ch-sol-cards"><div class="ch-sol-card"><div class="ch-sol-card-num">01</div><div class="ch-sol-card-title">Momento certo, esforço mínimo</div><div class="ch-sol-card-desc">O momento de disparo foi a decisão mais crítica: logo após o atendimento, quando a experiência ainda está fresca e o engajamento emocional é máximo. Fluxo em três telas, nenhuma com mais de 10 segundos de esforço — porque pergunta que aparece tarde ou que demora é pergunta sem resposta.</div></div><div class="ch-sol-card"><div class="ch-sol-card-num">02</div><div class="ch-sol-card-title">Expressão emocional sem barreiras</div><div class="ch-sol-card-desc">Escala numérica cria fricção cognitiva — o usuário para para calcular. Emoji é resposta imediata e emocional, sem barreira de interpretação. O contexto pós-consulta médica exige leveza: cores suaves, microcopy humano, zero pressão para detalhar.</div></div><div class="ch-sol-card"><div class="ch-sol-card-num">03</div><div class="ch-sol-card-title">Qualitativo como convite</div><div class="ch-sol-card-desc">Tornar o qualitativo obrigatório reduziria a taxa de resposta e contaminaria os dados — quem responde por obrigação responde mal. Aparece como convite após a avaliação principal: quem quer detalhar, detalha. A taxa de preenchimento voluntário superou benchmarks de NPS com campo obrigatório.</div></div></div><div class="ch-sol-aside"><div class="ch-sol-aside-label">A decisão mais negociada</div><p>O time de produto queria escala numérica de 1 a 10 — mais precisa para análise estatística. Defendi o emoji como primeira resposta: o contexto pós-consulta médica exige leveza, não rigor de pesquisa. A solução foi manter os dois — emoji como entrada emocional imediata e qualitativo aberto como bônus para quem quer detalhar. A taxa de resposta confirmou a decisão.</p></div>',
  ...
  bomconsorcio:{
    ...
    medicao:{texto:'O diagnóstico partiu do time de suporte, a categoria mais frequente de tickets era dúvida sobre andamento do processo, não erros técnicos. Esse padrão qualitativo validou o problema antes do primeiro wireframe e serviu como baseline para a hipótese de redução. Os resultados são projetados, o acesso aos dados pós-lançamento não estava no escopo do projeto.',tools:['Suporte — categorização qualitativa de tickets (dado substituto para pesquisa com usuários)','Análise de jornada do usuário no Figma — comparativo de altura de card antes/depois como evidência de redução de carga de leitura','Pipeline Figma → Tokens Studio → GitHub Actions — handoff automatizado','IA generativa: Claude e NotebookLM como ferramentas ativas no processo de discovery e documentação']},
    ...
    resultsLabel:'Resultados',
    results:[
      ['8 etapas','Stepper refeito com 8 etapas reais nomeadas, substituindo etapas genéricas que escondiam sub-passos do processo.','ti-list-check','check','entregue'],
  ...
  passaporte:{
    ...
    resultsLabel:'Resultados',
    medicao:{texto:'O sistema foi lançado em produção, então a cobertura completa (app + portal) e os canais de pagamento são fatos verificáveis do escopo entregue. Os demais resultados são projeções, já que não houve acesso a dados de uso pós-lançamento no escopo deste projeto, baseadas no acompanhamento qualitativo do fluxo durante o desenvolvimento.',tools:['Figma — wireframes, prototipagem de alta fidelidade, handoff para desenvolvimento','Validação interna — testes do fluxo de família e comparativo de métodos de pagamento','IA generativa: Claude, apoio na estruturação e documentação']},
    results:[
